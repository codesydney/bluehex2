function trimBurgerMenu(){document.querySelectorAll("#main-menu").forEach(function(e){e.innerHTML='<li class="main-menu__item"><a class="main-menu__link btn btn-anim" href="/"><span class="btn-caption">Home</span></a></li><li class="main-menu__item"><a class="main-menu__link btn btn-anim" href="/contact"><span class="btn-caption">Contact</span></a></li>'})}function applyBranding(){var e="Bluehex by Code.Sydney";document.title=e,document.querySelectorAll(".mxd-logo__text").forEach(function(t){t.textContent=e}),document.querySelectorAll(".mxd-logo__image").forEach(function(e){e.remove()}),document.querySelectorAll('link[rel=\"icon\"], link[rel=\"apple-touch-icon\"], link[rel=\"manifest\"]').forEach(function(e){e.remove()});var t=document.createElement(\"link\");t.rel=\"icon\",t.href=\"/static/img/favicon/bluehex.svg\",document.head.appendChild(t)}window.addEventListener("DOMContentLoaded",trimBurgerMenu),window.addEventListener("load",trimBurgerMenu),setTimeout(trimBurgerMenu,0),setTimeout(trimBurgerMenu,500),window.addEventListener("DOMContentLoaded",applyBranding),window.addEventListener("load",applyBranding),setTimeout(applyBranding,0),setTimeout(applyBranding,500);
/*! ------------------------------------------------
